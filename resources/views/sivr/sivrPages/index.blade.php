            ...
            <div class="g-sivr-tree-area">
                <div class="g-sivr-tree-main">
                       ...
                       ***********************************-->
                                ...
                                <div class="file-browser">
                                    ...
                                    <ul>
                                        ...
                                        <li class="{{$sivrPage->hasChildren()?'folder':'file'}} "><span data-sivrpage-id={{$sivrPage->id}} class="node-name">{{$sivrPage->page_heading_en}}</span>
                    ...
                    <div id="contextMenu" class="context-menu">
                        <ul class="list-group">
                            <li id="edit-option" class="" data-bs-toggle="modal" data-bs-target="#g-sivr-edit-modal"><i class="ph-fill ph-pencil-simple"></i>
                                Edit
                            </li>
                            <li id="add-option" class="" data-bs-target="#g-sivr-add-modal" data-bs-toggle="modal">
                                <i class="ph-fill ph-plus"></i> Add Branch
                            </li>
                            <li id="audio-upload-option" class="" data-bs-target="#g-sivr-audio-upload-modal" data-bs-toggle="modal"><i class="ph-fill ph-upload"></i> Upload
                                File
                            </li>
                            <li class="" data-bs-toggle="modal" id="node-element-option" data-bs-target="#node-element-modal"><i class="ph-fill ph-circles-three-plus"></i>
                                Node Element
                            </li>
                            <li class="" id="jsDeleteTreeConfirm"><i class="ph-fill ph-trash-simple"></i>
                                Delete Tree
 ...
 ***********************************-->
    <div class="modal fade" tabindex="-1" id="g-sivr-edit-modal" aria-lebeledby="editfile">
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="edit-page-form" method="POST" action="{{ route('sivr-pages.update', ['sivr_page' => 'PAGE']) }}">
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="page_heading_en" id="edit_page_heading_en" placeholder="Page Heading (EN)">
                        </div>

                        <div class="form-group mb-3">
                            <label for="edit_page_heading_ban">Page Heading (BN)</label>
                            <input type="text" class="form-control" name="page_heading_ban" id="edit_page_heading_ban" placeholder="Page Heading (BN)">
                        </div>
                ...
                <form id="add-page-form" method="POST" action="{{route("sivr-pages.store")}}">
                    <div class="modal-body">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control" name="page_heading_en" id="page_heading_en" placeholder="Page Heading (EN)">
                        </div>

                        <div class="form-group mb-3">
                            <label for="page_heading_ban">Page Heading (BN)</label>
                            <input type="text" class="form-control" name="page_heading_ban" id="page_heading_ban" placeholder="Page Heading (BN)">
                        </div>
    ...
    <!--**********************************
         ...
         ***********************************-->
    <div id="delete-toast" class="toast bg-white d-flex align-items-center justify-content-center position-fixed d-none" aria-live="assertive" aria-atomic="true" style="top: 50%; left: 50%; transform: translate(-50%, -50%);">

        <div class="toast-body">
            <h6>Are you sure you want to delete the node?</h6>
            <div class="pt-2 border-top">
                <form id="delete-sivrPage-form" action="{{ route('sivr-pages.destroy', ['sivr_page' => ':sivrpageid']) }}" method="POST">
                    @csrf
                    @method('DELETE')
                    <button id="delete-confirm" type="submit" class="btn btn-primary btn-sm text-white">Confirm
                    </button>
                    <button id="delete-cancel" type="button" class="btn btn-secondary btn-sm" data-bs-dismiss="toast">Cancel
                    </button>
                </form>
            </div>
        </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content modal-lg">
                ...
                <div class="modal-body">
                    ...
                    <form class=" mb-3 w-100" id="audioForm" method="POST" action="{{ route('sivr-pages.save-audio') }}" enctype="multipart/form-data" multiple>
                        @csrf
                    ...
                    <div class="g-player">
                        ...
                        <div class="g-player-controls">
                            <button class="btn btn-sm btn-secondary" id="previousButton"><i class="ph-fill ph-skip-back"></i></button>
                            <button class="btn btn-sm btn-secondary" id="nextButton"><i class="ph-fill ph-skip-forward"></i>
                            </button>
                        </div>
                    </div>
...
***********************************-->
    <div class="modal fade" id="edit-page-element-modal" aria-hidden="true" aria-labelledby="addNewPageElement" tabindex="-1">
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalToggleLabel2">Add New Page Element</h1>
                ...
                <form method="POST" id="edit-element-form" action="{{route("sivr-page-elements.update", ['sivr_page_element' => 'PAGE_ELEMENT'])}}">
                    <div class="modal-body">
                        ...
                        <div class="edit-page-element">
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input class="form-control" type="number" name="element_order" id="edit-element-order">
                            </div>

                            <div class="form-group mb-2">
                                <label for="edit-element-text-en">Text (EN)</label>
                                <input class="form-control" type="text" name="display_name_en" id="edit-element-text-en">
                            </div>

                            <div class="form-group mb-2">
                                <label for="edit-element-text-bn">Text (BN)</label>
                                <input class="form-control" type="text" name="display_name_bn" id="edit-element-text-bn">
                            </div>

                            <div class="d-flex justify-content-between">
                                <div class="form-group mb-2">
                                    <label for="edit-element-color">Text Color</label>
                                    <input class="form-control" type="color" name="text_color" id="edit-element-color">
                                </div>

                                <div class="form-group mb-2">
                                    <label for="edit-element-bg-color">Background Color</label>
                                    <input class="form-control" type="color" name="background_color" id="edit-element-bg-color">
                                </div>
                            </div>
                            ...
                            <div id="edit-no-row-column-area" style="display: none">
                                ...
                                <div class="form-group mb-2">
                                    ...
                                    <input class="form-control" type="number" name="columns" id="edit-element-no-columns">
                                </div>
                            ...
                            <div class="form-group mb-2">
                                ...
                                <input class="form-control" type="text" name="data_provider_function" id="edit-element-provider-function">
                            </div>
